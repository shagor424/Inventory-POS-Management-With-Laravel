    ...
    <section class="content">
        ...
        <!-- sl-page-title -->
                ...
                <div style="background-color: #a72c5d" class="card-header">
                 <span id="adi" style="color: white;font-size: 25px">Add Category</span>
                 <span id="upi" style="color: white;font-size: 25px">Update Category</span>
                 </div>
                     <div class="card-body">
                  ...
                  <input class="form-control" type="text" name="item_name" id="item_name"  placeholder="Enter Category Name">
                ...
                <div class="form-layout-footer">
                    <button type="submit" id="addi" name="submit" onclick="adddata()" class="btn btn-primary"><strong>Add Category</strong> </button>
                     <button type="submit" id="updi" name="submit" class="btn btn-primary" onclick="updatedata()"><strong>Update Category</strong> </button>
