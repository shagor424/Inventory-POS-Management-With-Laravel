          ...
          <section class="col-md-8 offset-md-2">
           ...
           <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{route('images.logos.store')}}" id="myform"enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                ...
                <input type="submit" value=" Submit Logo" name="submit" class="btn btn-danger float-right">
                  </div>
                </div> 
              </form>
