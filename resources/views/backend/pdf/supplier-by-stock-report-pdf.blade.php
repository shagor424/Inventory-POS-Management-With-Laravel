...
<html lang="en">
  ...
  <body>
        ...
        <div style="font-size: 18px;margin-top: 7px;font-weight: bold;text-align: center;"><u ><i>Supplier By Stock Report</i></u></div>
<br>
         <table width="100%" class="table table-bordered table-sm" border="1" width="100%">
                  <tbody>
                    <tr><th colspan="4" class="text-center" style="font-size: 20px">Supplier Information</th></tr>
                    <tr>
                     ...
                     <tr>
                      <td width="17%">{{$alldata['0']['supplier']['name']}}</td>
                      <td width="16%" style="text-align: center;">{{$alldata['0']['supplier']['mobile']}}</td>
                      <td width="18%">{{$alldata['0']['supplier']['email']}}</td>
                      <td width="33%">{{$alldata['0']['supplier']['address']}}</td>
                    </tr>
                  </tbody>
                </table>
                <br>
