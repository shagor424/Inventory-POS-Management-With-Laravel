           ...
           <div class="card">
            ...
            <div class="card-body">
              <table border="1" width="100%">
                ...
                <tr>
                  <td style="text-align: center;">{{$alldata['0']['category']['item_name']}}</td>
                  <td style="text-align: center;">{{$alldata['0']['product_name']}}</td>
                  <td style="text-align: center;">{{$alldata['0']['product_code']}}</td>
                </tr>
              </table>
               <br>
                ...
                <td>{{$product['subcategory']['item_name']}}</td>
                <td>{{$product['brand']['item_name']}}</td>
