...
<html lang="en">
  ...
  <!-- Theme style -->
    ...
    <title>Customer Invoice Wise Payment Summary</title>
  </head>
  <body>
            ...
            <div class="card-body">
                ...
                <table width="100%" border="1" class="table table-bordered table-sm" style="margin-bottom: 15px;padding-bottom: 0">
                  ...
                  <tr style="height: 20px">
                    <th colspan="4" style="height: 20px;font-size: 18px;padding: 8px 0px">Invoice Wise Customer Payment Summary</th>
                  </tr>
                  <thead>
                  <tr> 
                    <th>SL</th>
