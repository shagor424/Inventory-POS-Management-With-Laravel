...
<html lang="en">
  ...
  <!-- Theme style -->
    ...
    <title> Individual Customer Credit Report</title>
  </head>
  <body>
        ...
        <div style="font-size: 18px;margin-top: 7px;font-weight: bold;text-align: center;"><u ><i>Individual Customer Credit Report</i></u></div>
           <br>
