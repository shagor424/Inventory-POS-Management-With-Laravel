       ...
       <section class="col-md-6 offset-md-3">
           ...
           <div class="card">
              <div class="card-header">
                <h5>Add Customer
                  <a  href="{{route('customers.view')}}" class="btn btn-success btn-sm float-right"><i class="fa fa-list"> Customer List</i></a>
                </h5>
              </div> 
            <div class="card-body">
              ...
              <form method="post" action="{{route('customers.store')}}" id="myform">
                ...
                <input type="submit" value=" Add Customer" name="submit" class="btn btn-primary btn-block " >
                  </div>
                </div> 
              </form>
