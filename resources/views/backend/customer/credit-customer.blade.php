          ...
          <section class="col-md-12">
           ...
           <div class="card">
              <div class="card-header" style="background-color:   #f1c40f  ">
                <h5>  Credit Or Due Customer List
                  <a target="_blank"  href="{{route('customers.credit-pdf')}}" class="btn btn-success btn-sm float-right mr-5"><i class="fa fa-download"> Credit Or Due Customer Download</i></a>
            ...
            <div class="card-body">
               ...
               <td style="text-align: right;color: red;font-weight: bold;">{{$invoice['due_amount']}} </td> 
                      ...
                      <td style="text-align: center;">
                           ...
                           <a href="{{ route('customers.invoice-edit',$invoice->invoice_id) }}" class="btn btn-primary btn-xs"  title="Edit Invoice"> <i class="fa fa-edit"></i></a>
                           <a href="{{ route('customers.invoice-details-pdf',$invoice->invoice_id) }}" class="btn btn-success btn-xs" target="_blank"  title="Customer Payment Summary"> <i class="fa fa-eye"></i></a>
