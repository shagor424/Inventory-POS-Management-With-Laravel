       ...
       <section class="col-md-6 offset-md-3">
           ...
           <div class="card">
              <div style="background: green;color: #fff" class="card-header">
                <h5>Update Supplier
                  <a  href="{{route('suppliers.view')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-list"> Supplier List</i></a>
                </h5>
              </div> 
            <div class="card-body">
              ...
              <form method="post" action="{{route('suppliers.update',$editdata->id)}}" id="myform">
                ...
                <input type="submit" value=" Update Supplier" name="submit" class="btn btn-primary btn-block " >
                  </div>
                </div> 
              </form>
